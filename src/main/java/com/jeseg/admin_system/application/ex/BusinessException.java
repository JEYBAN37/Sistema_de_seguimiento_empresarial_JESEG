...
public class BusinessException extends ApplicationException {
    ...
    public enum Type {
        ...
        ERROR_GUARDAR_HIERARCHY_COMPANIA_NO_EXISTE(new Error(CodigosErrorNegocio.NEGOCIO_2, TipoError.NEGOCIO, "Error al cargar Imagenes", "Las imagenes no se pueden cargar porque la tarea no existe")),
        ...
        ERROR_GUARDAR_TAREA_NO_EXISTE(new Error(CodigosErrorNegocio.NEGOCIO_2, TipoError.NEGOCIO, "Error al guardar tarea no existe", "La tarea no existe")),
        ERROR_TAREA_NO_EXISTE(new Error(CodigosErrorNegocio.NEGOCIO_2, TipoError.NEGOCIO, "Error al guardar tarea no existe", "La tarea no existe")),
