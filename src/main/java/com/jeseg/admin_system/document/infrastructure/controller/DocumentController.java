...
public class DocumentController {
    ...
    public ResponseEntity<List<DocumentResponse>> getDocumentsByTaskId(@PathVariable Long taskId) {
        return ResponseEntity.ok(documentService.getDocumentsByTaskId(taskId));
    }
